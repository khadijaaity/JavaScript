...
function doblar(imagen){
	imagen.style.height*=2;
	imagen.style.width*=2;
}

function escalar(elemento,escal){
	elemento.style.height*=escal;
	elemento.style.width*=escal;

}

function escala(elemento){
	elemento.style.height = (elemento.style.height * 1.3) + 'px';
	elemento.style.width = (elemento.style.width * 1.3) + 'px';

}

function reducir(elemento){
	elemento.style.height = (elemento.style.height * 0.769) + 'px';
	elemento.style..width = (elemento.style.width * 0.769) + 'px';
}
